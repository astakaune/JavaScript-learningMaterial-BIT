...
class Burbulai {
    ...
    static gamerName = document.querySelector('#gamer');
    ...
    static start() {
        ...
        startButton.addEventListener('click', e => {
            e.stopPropagation();
            for (let i = 1; i <= 5; i++) {
                setTimeout(this.newBall, this.rand(1, 2000));
                // Ball.newBall();
            }
            document.querySelector('body').addEventListener('click', this.newBall());

            this.startButton.style.display = 'none';
            this.gamerName.style.display = 'none';
            this.gamer = this.gamerName.value;
    ...
    static gameEnd() {
        ...
        this.gamerName.style.display = "block";
